...
namespace PortalRandkowy.API.Models.Data
{
    public class DataContext : DbContext
    {
        ...
        {
            builder.Entity<Like>().HasKey(k => new { k.UserLikesId, k.UserIsLikesId});

            builder.Entity<Like>().HasOne(u => u.UserIsLikes)
                                  .WithMany(u => u.UserLikes)
                                  .HasForeignKey(u => u.UserIsLikesId)
                                  .OnDelete(DeleteBehavior.Restrict);
                        
            builder.Entity<Like>().HasOne(u => u.UserLikes)
                                  .WithMany(u => u.UserIsLikes)
