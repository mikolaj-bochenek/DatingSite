...
namespace PortalRandkowy.API.Migrations
{
    ...
    [Migration("20191001111342_AddedMessageEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortalRandkowy.API.Models.Like", b =>
                {
                    ...
                    b.Property<int>("UserIsLikesId");

                    b.HasKey("UserLikesId", "UserIsLikesId");

                    b.HasIndex("UserIsLikesId");
            ...
            modelBuilder.Entity("PortalRandkowy.API.Models.User", b =>
                {
                    ...
                    b.Property<string>("MakesMeHappy");
            ...
            modelBuilder.Entity("PortalRandkowy.API.Models.Like", b =>
                {
                    b.HasOne("PortalRandkowy.API.Models.User", "UserIsLikes")
                        .WithMany("UserLikes")
                        .HasForeignKey("UserIsLikesId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("PortalRandkowy.API.Models.User", "UserLikes")
                        .WithMany("UserIsLikes")
